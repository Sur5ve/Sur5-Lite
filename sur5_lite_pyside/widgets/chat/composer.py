...
class MessageComposer(QWidget):
    ...
    def set_model_available(self, available: bool):
        ...
        if available:
            self.text_input.setPlaceholderText("Chat with Sur... (Enter to send, Shift+Enter for newline)")
        else:
            self.text_input.setPlaceholderText("Load a model to chat with Sur...")
